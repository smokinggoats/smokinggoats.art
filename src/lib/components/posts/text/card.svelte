<script lang="ts">
	...
	export let text: TextPost;
	function goToPost() {
		goto(ROUTES.cctextId(text.id));
	}
</script>
...
<button class="card" on:click={goToPost}>
	<div class="card__image">
		<img
			...
			src={directusClient.getImageLink(text.header)}
			alt={text.title}
		/>
	</div>
	<div class="card__content">
		<div class="card__content__title">{text.title}</div>
		<a class="card__content__link" href={ROUTES.cctextId(text.id)}>
